          ...
          >
            ...
            <div className="space-y-6 text-pretty text-[#E8D9B5]/70">
              <p className="text-lg leading-relaxed">
                Ноён Борх нь Монголын тэргүүлэх металл боловсруулалтын компани бөгөөд уламжлалт дархны ур чадварыг орчин үеийн аж үйлдвэрийн технологитой хослуулан чанартай, шинэлэг бүтээгдэхүүн үйлдвэрлэдэг.
              </p>
