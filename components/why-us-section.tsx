...
const reasons = [
  {
    ...
    description: " CE стандартад нийцсэн металл боловсруулалт НОЁН БОРХ ",
  },
  {
    icon: Clock,
    title: "Цаг хугацаандаа хүргэлт",
    description: "Гэрээнд заагдсан цаг, хувиарт хугацаанд дуусгахыг баталгаажуулна.",
  },
  {
    icon: Shield,
    title: "Аюулгүй байдал ",
    description: "Зөв технологи, хариуцлагатай гүйцэтгэлээр аюулгүй орчныг.",
  },
  {
    icon: Wrench,
    title: "Мэргэжлийн ур чадвар",
    description: "Олон жилийн дадлага туршлагатай гагнуурчид, мэргэжлийн будагчин, инженерчлэл.",
  },
  {
    icon: Sparkles,
      ...
      <div ref={ref} className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-2xl text-pretty text-[#E8D9B5]/60">
            Бид металл хийцлэлээр таны хүсэл, санааг бодит бүтээл болгон урлаж, орчин үеийн өнгө төрхийг нэг дор цогцлооно.
          </p>
        </motion.div>
